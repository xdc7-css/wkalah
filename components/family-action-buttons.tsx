    ...
    <>
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:flex-wrap">
        <Link
          ...
          className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 text-sm font-bold text-white transition-all hover:bg-white/10 active:scale-95 sm:w-auto sm:rounded-2xl"
        >
        ...
        <button
          ...
          className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 text-sm font-bold text-white transition-all hover:bg-white/10 active:scale-95 sm:w-auto sm:rounded-2xl"
        >
          <Snowflake className="size-4 text-sky-400" />
        ...
        <button
          ...
          className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl border border-red-500/20 bg-red-500/5 px-4 text-sm font-bold text-red-400 transition-all hover:bg-red-500/10 active:scale-95 sm:w-auto sm:rounded-2xl"
        >
